...
class TestSHAPLLMInsightExplainability:
    ...
    def test_shap_explains_feature_importance_for_insights(self, db, sample_brand_with_data):
        ...
        """
        print("\n" + "="*80)
        print("🚀 TEST STARTED: test_shap_explains_feature_importance_for_insights")
        print("="*80)

        print("\n📦 Unpacking fixture data...")
        ...
        def insight_scorer(feature_matrix):
            ...
            for idx, features in enumerate(feature_matrix):
                ...
                print(f"\n🔄 SHAP Call #{call_count[0]} - Evaluating features:")
                ...
                try:
                    ...
                    print(f"   ✅ Generated {len(insights)} insights → Urgency score: {urgency_score}")
        ...
        print("\n" + "="*80)
        print("📊 SHAP FEATURE IMPORTANCE TEST")
        print("="*80)
        print("Testing which features influence LLM insight urgency:")
        print("  • Features: avg_sentiment, avg_echo_score, pain_point_count, total_mentions, engagement_rate")
        print(f"  • Background samples: {len(X_background)}")
        print(f"  • Test samples: {len(X_test)}")
        print(f"  • SHAP samples per test: 10")
        print(f"  • Expected API calls: ~10-20")
        ...
        print("\n🚀 Starting SHAP value calculation (this will make multiple OpenAI API calls)...")
    ...
    def test_shap_feature_attribution_structure(self):
        ...
        print("\n✅ SHAP library is properly integrated and working")
